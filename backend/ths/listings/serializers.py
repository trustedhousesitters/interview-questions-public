...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    def get_overlaps(self, data: dict[str:Any]) -> QuerySet[Assignment]:
        ...
        return Assignment.objects.select_related("listing").filter(
            starts_before | starts_during, listing=data.get("listing")
        )
    ...
    def validate(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        for overlap in overlaps:
            message = (
                f"Overlapping Assignment found "
                f"starts: {overlap.start_date} "
                f"ends: {overlap.end_date}."
            )
    ...
    def validate_start_date(self, value: dt.date) -> dt.date:
        ...
        Check the following:
            ...
            * The assignment doesn't overlap with any existing
              assignments for this listing.
        """
